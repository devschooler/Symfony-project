...
namespace Proxies\__CG__\TD\CinemaBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Personne extends \TD\CinemaBundle\Entity\Personne implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TD\\CinemaBundle\\Entity\\Personne' . "\0" . 'id', '' . "\0" . 'TD\\CinemaBundle\\Entity\\Personne' . "\0" . 'nom', '' . "\0" . 'TD\\CinemaBundle\\Entity\\Personne' . "\0" . 'prenom', '' . "\0" . 'TD\\CinemaBundle\\Entity\\Personne' . "\0" . 'dateDeNaissance', '' . "\0" . 'TD\\CinemaBundle\\Entity\\Personne' . "\0" . 'biographie', '' . "\0" . 'TD\\CinemaBundle\\Entity\\Personne' . "\0" . 'films'];
        }
